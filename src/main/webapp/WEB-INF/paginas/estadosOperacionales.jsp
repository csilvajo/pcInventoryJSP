...
<html>
    <head>
        <title>Estados Operativos</title>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header text-center">
                    <h4>Tipos de Estados Operacionales</h4> 
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br> 
                        <form action="EstadoOperacionalController?menu=estadosOperacionales" method="POST">
                            <div class="form-group">
                                <label>Tipo de Estado Operacional: </label>
                                <input type="text" name="txtEstadoOperacional" class="form-control" value="${estado.getEstadoOperativo()}" required="true" placeholder="Ingrese Tipo de Estado Operacional">
                            </div> 
                    ...
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            <thead class="thead-dark">
                                <tr>
                                    <th>#</th>
                                    <th>Tipo de Estado Operacional</th>
                                    <th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- Se trae la lista de estados operativos enviada por el controlador-->
                                <c:forEach var="estado" items="${listaEstadosOperacionales}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${estado.getEstadoOperativo()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="EstadoOperacionalController?menu=estadosOperacionales&accion=Editar&id=${estado.getIdEstadoOperativo()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger"  href="EstadoOperacionalController?menu=estadosOperacionales&accion=Eliminar&id=${estado.getIdEstadoOperativo()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
