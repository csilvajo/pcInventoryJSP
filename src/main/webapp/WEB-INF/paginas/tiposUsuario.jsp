            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="TipoUsuarioController?menu=tiposUsuario" method="POST">
                            <div class="form-group">
                                <label>Tipo de Usuario:</label>
                                <input type="text" name="txtTipoUsuario" class="form-control" value="${tipoUsuario.getTipoUsuario()}" required="true" placeholder="Ingrese Tipo de Usuario" autofocus="true">
                            </div> 
                    ...
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de los tipos de usuario enviada por el controlador-->
                                <c:forEach var="tipoUsuario" items="${listaTiposUsuario}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${tipoUsuario.getTipoUsuario()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="TipoUsuarioController?menu=tiposUsuario&accion=Editar&id=${tipoUsuario.getIdTipoUsuario()}"><i class="fa fa-pencil"></i> Editar</a>  
                                            <a class="btn btn-danger" href="TipoUsuarioController?menu=tiposUsuario&accion=Eliminar&id=${tipoUsuario.getIdTipoUsuario()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
