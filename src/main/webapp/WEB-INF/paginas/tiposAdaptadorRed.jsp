...
<html>
    <head>
        <title>Tipos de Adaptador de Red</title>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header text-center">
                    <h4>Tipos de Adaptador de Red</h4> 
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="TipoAdaptadorRedController?menu=tiposAdaptadorRed" method="POST">
                            <div class="form-group">
                                <label>Tipo de Adaptador de Red: </label>
                                <input type="text" name="txtTipoAdaptadorRed" class="form-control" value="${tipoAdaptadorRed.getTipoAdaptadorRed()}" required="true" placeholder="Ingrese Tipo de Adaptador" autofocus="true" >
                            </div> 
                    ...
                    <!-- Tabla del mantenedor de Tipos de Usuario-->
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            <thead class="thead-dark">
                                <tr>
                                    <th>#</th>
                                    <th>Tipo de Adaptador de Red</th>
                                    <th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- Se trae la lista de los Tipos de Adaptador de Red enviada por el controlador-->
                                <c:forEach var="tipoAdaptadorRed" items="${listaTiposAdaptadorRed}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${tipoAdaptadorRed.getTipoAdaptadorRed()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="TipoAdaptadorRedController?menu=tiposAdaptadorRed&accion=Editar&id=${tipoAdaptadorRed.getIdTipoAdaptadorRed()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger"  href="TipoAdaptadorRedController?menu=tiposAdaptadorRed&accion=Eliminar&id=${tipoAdaptadorRed.getIdTipoAdaptadorRed()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <!-- Fin Tabla del mantenedor de Tipos de Usuario-->
                </div>
                <!-- Fin card-body -->
            </div>
            <!-- Fin card -->            
