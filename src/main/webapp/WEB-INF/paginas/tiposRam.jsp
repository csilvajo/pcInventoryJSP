            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="TipoRAMController?menu=tiposRam" method="POST">
                            <div class="form-group">
                                <label>Tipo de Memoria RAM: </label>
                                <input type="text" name="txtTipoRam" class="form-control" value="${tipoRam.getTipoRam()}"  required="true" placeholder="Ingrese Tipo de Memoria" autofocus="true">
                            </div> 
                    ...
                    <!-- Tabla del mantenedor de Tipos de Memoria-->
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de los tipos de memoria enviada por el controlador-->
                                <c:forEach var="tipoRam" items="${listaTiposRam}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${tipoRam.getTipoRam()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="TipoRAMController?menu=tiposRam&accion=Editar&id=${tipoRam.getIdTipoRam()}"><i class="fa fa-pencil"></i> Editar</a>  
                                            <a class="btn btn-danger"  href="TipoRAMController?menu=tiposRam&accion=Eliminar&id=${tipoRam.getIdTipoRam()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <!-- Fin Tabla del mantenedor de Tipos de Memoria-->
                </div>
                <!-- Fin card-body -->
            </div>
            <!-- Fin card -->            
