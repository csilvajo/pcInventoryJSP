            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="MarcaController?menu=marcas" method="POST">
                            <div class="form-group">
                                <label>Marca: </label>
                                <input type="text" name="txtMarca" class="form-control" value="${marca.getMarca()}" required="true" placeholder="Ingrese una Marca" autofocus="true">
                            </div> 
                    ...
                    <!-- Tabla del mantenedor de Marcas -->
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de marcas enviada por el controlador-->
                                <c:forEach var="marca" items="${listaMarcas}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${marca.getMarca()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="MarcaController?menu=marcas&accion=Editar&id=${marca.getIdMarca()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger" href="MarcaController?menu=marcas&accion=Eliminar&id=${marca.getIdMarca()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <!-- Fin Tabla del mantenedor de Marcas -->                    
                </div>
                <!-- Fin card-body -->
            </div>
            <!-- Fin card -->  
