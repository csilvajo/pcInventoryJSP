            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="UnidadController?menu=unidades" method="POST">
                            <div class="form-group">
                                <label>Unidad:</label>
                                <input type="text" name="txtNombreUnidad" class="form-control" minlength="4" value="${unidad.getUnidad()}" required="true" placeholder="Ingrese Unidad" autofocus="true">
                            </div> 
                    ...
                    <div class="card col-sm-9">                        
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de unidades enviada por el controlador-->
                                <c:forEach var="unidad" items="${listaUnidades}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${unidad.getUnidad()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="UnidadController?menu=unidades&accion=Editar&id=${unidad.getIdUnidad()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger" href="UnidadController?menu=unidades&accion=Eliminar&id=${unidad.getIdUnidad()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
