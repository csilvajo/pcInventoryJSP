...
<html>
    <head>
        <title>Tipos de Procesador</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="TipoProcesadorController?menu=tiposProcesador" method="POST">
                            <div class="form-group">
                                <label>Tipo de Procesador: </label>
                                <input type="text" name="txtTipoProcesador" class="form-control" value="${tipoProcesador.getTipoProcesador()}" required="true" placeholder="Ingrese Tipo de Procesador" autofocus="true">
                            </div> 
                    ...
                    <!-- Tabla del mantenedor de Tipos de Procesador-->
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de los tipos de procesador enviada por el controlador-->
                                <c:forEach var="tipoProcesador" items="${listaTiposProcesador}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${tipoProcesador.getTipoProcesador()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="TipoProcesadorController?menu=tiposProcesador&accion=Editar&id=${tipoProcesador.getIdTipoProcesador()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger" href="TipoProcesadorController?menu=tiposProcesador&accion=Eliminar&id=${tipoProcesador.getIdTipoProcesador()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <!-- Fin Tabla del mantenedor de Tipos de Procesador-->
                </div>
                <!-- Fin card-body -->
            </div>
            <!-- Fin card -->            
