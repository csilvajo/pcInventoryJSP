            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>             
                        <form action="SistemaOperativoController?menu=sistemasOperativos" method="POST">
                            <div class="form-group">
                                <label>Sistema Operativo: </label>
                                <input type="text" name="txtSistemaOperativo" class="form-control" value="${sistemaOperativo.getSistemaOperativo()}" required="true" placeholder="Ingrese Sistema Operativo" autofocus="true">
                            </div> 
                    ...
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de los Sistemas Operativos enviada por el controlador-->
                                <c:forEach var="sistemaOperativo" items="${listaSistemasOperativos}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${sistemaOperativo.getSistemaOperativo()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="SistemaOperativoController?menu=sistemasOperativos&accion=Editar&id=${sistemaOperativo.getIdSistemaOperativo()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger"  href="SistemaOperativoController?menu=sistemasOperativos&accion=Eliminar&id=${sistemaOperativo.getIdSistemaOperativo()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
