...
<html>
    <head>
        <title>Tipos de Disco Duro</title>
            ...
            <div class="card">
                ...
                <div class="card-body d-flex">
                    ...
                    <div class="card col-sm-3">
                        ...
                        <br>
                        <form action="TipoDiscoDuroController?menu=tiposDiscoDuro" method="POST">
                            <div class="form-group">
                                <label>Tipo de Disco Duro: </label>
                                <input type="text" name="txtTipoDiscoDuro" class="form-control" value="${tipoDisco.getTipoDiscoDuro()}" required="true" placeholder="Ingrese Tipo de Disco Duro" autofocus="true">
                            </div> 
                    ...
                    <div class="card col-sm-9">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <!-- Se trae la lista de los tipos de disco duro enviada por el controlador-->
                                <c:forEach var="tipoDisco" items="${listaTiposDiscoDuro}" varStatus="id">
                                    <tr>                            
                                        <td>${id.count}</td><!-- valor autoincrementable que reemplaza el id-->
                                        <td>${tipoDisco.getTipoDiscoDuro()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="TipoDiscoDuroController?menu=tiposDiscoDuro&accion=Editar&id=${tipoDisco.getIdTipoDiscoDuro()}"><i class="fa fa-pencil"></i> Editar</a> 
                                            <a class="btn btn-danger"  href="TipoDiscoDuroController?menu=tiposDiscoDuro&accion=Eliminar&id=${tipoDisco.getIdTipoDiscoDuro()}"><i class="fas fa-trash"></i> Eliminar</a> 
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
